...
<div class="list_hdcnt">
 <form id="add_user" name="add_user" action="inServlet4" method="post" onsubmit="return validate()">
			  <table width="100%" align="center" cellpadding="0" cellspacing="0" border="1" bordercolor="#BBBBBB">
                <tbody>
               
                    <tr class="TDtop">
     <td height="25" colspan="8" align="center" bgcolor="#D3E3ED" class="bs_bg"><div align="center">全 国 计 算 机 等 级 考 试 报 名 表</div></td>
                    </tr>
