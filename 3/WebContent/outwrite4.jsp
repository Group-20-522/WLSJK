...
<div class="list_hdcnt">
 <form id="add_user" name="add_user" action="update_inServlet4" method="post">
			  <table width="85%" align="center" cellpadding="0" cellspacing="0" border="1" bordercolor="#BBBBBB">
                <tbody>
               
                    <tr class="TDtop">
     <td height="25" colspan="8" align="center" bgcolor="#D3E3ED" class="bs_bg"><div align="center">全 国 计 算 机 等 级 考 试 考 生 信 息 表</div></td>
                    </tr>
                  ...
                  <tr>
                    <td align="right" width="104" bgcolor="#d4d8e2" height="27">报考级别：</td>
                    <td align="left" width="104" bgcolor="#d4d8e2" height="27"><%=baokaojibie %></td>
                  </tr>
