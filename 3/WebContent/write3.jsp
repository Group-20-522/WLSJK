 ...
 <form id="add_user" name="add_user" action="inServlet3" method="post" onsubmit="return validate()">
			  <table width="85%" align="center" cellpadding="0" cellspacing="0" border="1" bordercolor="#BBBBBB">
                <tbody>
                    ...
                    <tr class="TDtop">
     <td height="25" colspan="8" align="center" bgcolor="#D3E3ED" class="bs_bg"><div align="center">超 级 机 构 地 质 专 业 研 究 生 考 试 报 名 表</div></td>
                    </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" width="218" bgcolor="#FFFFFF" height="27">
                    <select name="maritalstatus" size="1" class="login_username" style="BORDER-RIGHT: 1px solid; PADDING-RIGHT: 4px; BORDER-TOP: 1px solid; PADDING-LEFT: 4px; PADDING-BOTTOM: 1px; BORDER-LEFT: 1px solid; PADDING-TOP: 1px; BORDER-BOTTOM: 1px solid">
                  ...
                  <tr>
                    ...
                    <td width="218" bgcolor="#FFFFFF" height="27"><select name="origin" size="1" class="login_username"> 
                        <option value="本科毕业生" selected="">本科毕业生</option>
                        <option value="成人应届本科毕业生">成人应届本科毕业生</option>
                  ...
                  <tr>
                    ...
                    <td width="218" bgcolor="#FFFFFF" height="27"><select name="soldier" size="1" class="login_username"> 
                        <option value="在职干部">在职干部</option>
                        <option value="国防生">国防生</option>
                        <option value="军校应届">军校应届</option>
              ...
              <tr>
                    ...
                    <td width="218" bgcolor="#FFFFFF" height="27"><select name="politicalstatus" size="1" class="login_username"> 
