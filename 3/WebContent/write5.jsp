...
<script   Language="javaScript">   
		...
		{   
				...
				if (add_user.dotime.value=="")   
				{   
						alert("工作年限不能为空.");   
						document.add_user.dotime.focus();   
						return false  ;   
				}
 ...
 <form id="add_user" name="add_user" action="inServlet5" method="post" onsubmit="return validate()">
			  <table width="100%" align="center" cellpadding="0" cellspacing="0" border="1" bordercolor="#BBBBBB">
                <tbody>
                    ...
                    <tr class="TDtop">
     <td height="25" colspan="8" align="center" bgcolor="#D3E3ED" class="bs_bg"><div align="center">全 国 会 计 资 格 考 试 报 名 表</div></td>
                    </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" width="218" bgcolor="#FFFFFF" height="27">
                    <select name="sex" size="1" class="login_username" style="BORDER-RIGHT: 1px solid; PADDING-RIGHT: 4px; BORDER-TOP: 1px solid; PADDING-LEFT: 4px; PADDING-BOTTOM: 1px; BORDER-LEFT: 1px solid; PADDING-TOP: 1px; BORDER-BOTTOM: 1px solid">
                  ...
                  <tr>
                    ...
                    <td width="218" bgcolor="#FFFFFF" height="27"><select name="zhuanye" size="1" class="login_username"> 
                    <option value="会计专业" selected="">会计专业</option>
                        <option value="财经专业">财经专业</option>
                        <option value="贸易专业">贸易专业</option>
                  ...
                  <tr>
                    ...
                    <td width="218" bgcolor="#FFFFFF" height="27"><select name="xuelixingzhi" size="1" class="login_username"> 
                    <option value="全日制普通高等院校" selected="">全日制普通高等院校</option>
                        <option value="函授">函授</option>
                        <option value="高教自考">高教自考</option>
                   ...
                   <tr>
                    <td align="right" width="104" bgcolor="#FFFFFF" height="27">&nbsp;&nbsp; 工作年限：</td>
                    <td width="218" bgcolor="#FFFFFF" height="27"><input name="dotime" class="login_username" id="schooladdress">
                        <span class="样式4">*</span> </td>        
                  </tr>
                  ...
                  <tr>
                    ...
                    <td width="218" bgcolor="#FFFFFF" height="27"><select name="baokaojibie" size="1" class="login_username"> 
                    ...
                    <td width="218" bgcolor="#FFFFFF" height="27"><input name="zhiwu" class="login_username" id="schooladdress">
