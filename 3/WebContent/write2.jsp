...
<div class="list_hdcnt">
 <form id="add_user" name="add_user" action="inServlet2" method="post">
			  <table width="100%" align="center" cellpadding="0" cellspacing="0" border="1" bordercolor="#BBBBBB">
                <tbody>
               
                    <tr class="TDtop">
     <td height="25" colspan="8" align="center" bgcolor="#D3E3ED" class="bs_bg"><div align="center">英 语 六 级 考 试 报 名 表</div></td>
                    </tr>
                  ...
                  <tr>
                   ...
                   <select name="year" class="login_username" id="month">
                  ...
                  <tr>
                    <td align="right" width="104" bgcolor="#FFFFFF" height="27">&nbsp;身份证号码：</td>
                    <td width="218" bgcolor="#FFFFFF" height="27"><input name="sfid" class="login_username" id="sfid"> 
                      <span class="样式4">*</span></td>
                  </tr>
                  ...
                  <tr>
                    <td align="right" width="104" bgcolor="#FFFFFF" height="27">&nbsp;&nbsp; 英语四级考试成绩：</td>
                    <td width="218" bgcolor="#FFFFFF" height="27"><input name="grade" class="login_username" id="grade">
                        <span class="样式4">*</span> </td>
                    <td width="196" bgcolor="#FFFFFF" height="27">大学英语四级考试成绩达到425分以上(含425分)的在校大学生可报考！</td>
                  </tr>
